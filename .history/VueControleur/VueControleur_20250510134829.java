...
public class VueControleur extends JFrame implements Observer {
    ...
    public static void main(String[] args) {
        ...
        // jeu.demandeDeplacementPiece(jeu.getPlateau().getCases()[0][0], jeu.getPlateau().getCases()[0][1]);
        // jeu.demandeDeplacementPiece(jeu.getPlateau().getCases()[0][1], jeu.getPlateau().getCases()[0][2]);
